      ...
      <section className="w-full max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="md:col-span-2 space-y-6 text-sm md:text-base">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <h2 className="text-neutral-400 uppercase font-semibold">Director</h2>
              <p>{movie.director?.nombre} {movie.director?.apellidos}</p>
            </div>
            <div>
              <h2 className="text-neutral-400 uppercase font-semibold">Duración</h2>
            ...
            <div>
              <h2 className="text-neutral-400 uppercase font-semibold">Clasificación</h2>
              <p>{movie.clasificacion}</p>
            </div>
            <div>
              <h2 className="text-neutral-400 uppercase font-semibold">Productora</h2>
              <p>{movie.productora}</p>
            </div>
          </div>

          <div>
            <h2 className="text-neutral-400 uppercase font-semibold mb-2">Sinopsis</h2>
            <p className="leading-relaxed">{movie.sinopsis}</p>
          </div>

          <div className="pt-4">
            <Boton className="py-3 px-6 bg-white text-black rounded hover:bg-neutral-200">
              Comprar entradas
            </Boton>
          </div>
        </div>
